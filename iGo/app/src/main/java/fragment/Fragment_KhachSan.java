...
public class Fragment_KhachSan extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // ánh xạ view
        View view = inflater.inflate(R.layout.fragment__khach_san, container, false);
        rcvcf = view.findViewById(R.id.revfragKhachSan);
